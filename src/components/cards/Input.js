...
const Input = (props) => {
    ...
    return (
        <div>
            ...
            <input placeholder={props.placeholder} value={props.value} id={props.id} type={props.type} name={props.id} className="input-fill input-validation" required={props.required} onChange={getData} />
